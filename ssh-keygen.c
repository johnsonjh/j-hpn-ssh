...
#ifdef WITH_OPENSSL
  maxbits = (type == KEY_DSA) ? OPENSSL_DSA_MAX_MODULUS_BITS
...
static struct sshkey *load_identity(char *filename) {
  char *pass;
  struct sshkey *prv;
  int r;
...
static struct sshkey *do_convert_private_ssh2_from_blob(u_char *blob,
                                                        u_int blen) {
  struct sshbuf *b;
...
static void do_gen_all_hostkeys(struct passwd *pw) {
  struct {
    ...
    char *path;
      ...
      {"rainbowiclassic", "RAINBOW_I_CLASSIC",
       _PATH_HOST_RAINBOW_I_CLASSIC_KEY_FILE},
      {"rainbowiiiclassic", "RAINBOW_III_CLASSIC",
       _PATH_HOST_RAINBOW_III_CLASSIC_KEY_FILE},
      {"rainbowvclassic", "RAINBOW_V_CLASSIC",
       _PATH_HOST_RAINBOW_V_CLASSIC_KEY_FILE},
      {"sphincsharaka128frobust", "SPHINCS_HARAKA_128F_ROBUST",
       _PATH_HOST_SPHINCS_HARAKA_128F_ROBUST_KEY_FILE},
      {"sphincssha256128frobust", "SPHINCS_SHA256_128F_ROBUST",
       _PATH_HOST_SPHINCS_SHA256_128F_ROBUST_KEY_FILE},
      {"sphincsshake256128frobust", "SPHINCS_SHAKE256_128F_ROBUST",
...
#ifdef WITH_OPENSSL
      {"rsa3072_oqsdefault", "RSA3072_OQSDEFAULT",
       _PATH_HOST_RSA3072_OQSDEFAULT_KEY_FILE},
      {"rsa3072_dilithium2", "RSA3072_DILITHIUM_2",
       _PATH_HOST_RSA3072_DILITHIUM_2_KEY_FILE},
      {"rsa3072_falcon512", "RSA3072_FALCON_512",
       _PATH_HOST_RSA3072_FALCON_512_KEY_FILE},
      {"rsa3072_picnicl1full", "RSA3072_PICNIC_L1FULL",
       _PATH_HOST_RSA3072_PICNIC_L1FULL_KEY_FILE},
      {"rsa3072_picnic3l1", "RSA3072_PICNIC3_L1",
       _PATH_HOST_RSA3072_PICNIC3_L1_KEY_FILE},
      {"rsa3072_rainbowiclassic", "RSA3072_RAINBOW_I_CLASSIC",
       _PATH_HOST_RSA3072_RAINBOW_I_CLASSIC_KEY_FILE},
      {"rsa3072_sphincsharaka128frobust", "RSA3072_SPHINCS_HARAKA_128F_ROBUST",
       _PATH_HOST_RSA3072_SPHINCS_HARAKA_128F_ROBUST_KEY_FILE},
      {"rsa3072_sphincssha256128frobust", "RSA3072_SPHINCS_SHA256_128F_ROBUST",
       _PATH_HOST_RSA3072_SPHINCS_SHA256_128F_ROBUST_KEY_FILE},
      {"rsa3072_sphincsshake256128frobust",
       "RSA3072_SPHINCS_SHAKE256_128F_ROBUST",
       _PATH_HOST_RSA3072_SPHINCS_SHAKE256_128F_ROBUST_KEY_FILE},
#ifdef OPENSSL_HAS_ECC
      {"p256_oqsdefault", "P256_OQSDEFAULT",
       _PATH_HOST_P256_OQSDEFAULT_KEY_FILE},
      {"p256_dilithium2", "P256_DILITHIUM_2",
       _PATH_HOST_P256_DILITHIUM_2_KEY_FILE},
      {"p256_falcon512", "P256_FALCON_512",
       _PATH_HOST_P256_FALCON_512_KEY_FILE},
      {"p256_picnicl1full", "P256_PICNIC_L1FULL",
       _PATH_HOST_P256_PICNIC_L1FULL_KEY_FILE},
      {"p256_picnic3l1", "P256_PICNIC3_L1",
       _PATH_HOST_P256_PICNIC3_L1_KEY_FILE},
      {"p256_rainbowiclassic", "P256_RAINBOW_I_CLASSIC",
       _PATH_HOST_P256_RAINBOW_I_CLASSIC_KEY_FILE},
      {"p384_rainbowiiiclassic", "P384_RAINBOW_III_CLASSIC",
       _PATH_HOST_P384_RAINBOW_III_CLASSIC_KEY_FILE},
      {"p521_rainbowvclassic", "P521_RAINBOW_V_CLASSIC",
       _PATH_HOST_P521_RAINBOW_V_CLASSIC_KEY_FILE},
      {"p256_sphincsharaka128frobust", "P256_SPHINCS_HARAKA_128F_ROBUST",
       _PATH_HOST_P256_SPHINCS_HARAKA_128F_ROBUST_KEY_FILE},
      {"p256_sphincssha256128frobust", "P256_SPHINCS_SHA256_128F_ROBUST",
       _PATH_HOST_P256_SPHINCS_SHA256_128F_ROBUST_KEY_FILE},
      {"p256_sphincsshake256128frobust", "P256_SPHINCS_SHAKE256_128F_ROBUST",
...
///// OQS_TEMPLATE_FRAGMENT_ADD_HYBRID_KT_END
  ...
  public
    ...
    if ((r = sshkey_save_private(private, prv_tmp, "", comment, use_new_format,
                                 new_format_cipher, rounds)) != 0) {
 ...
 * Print the SSHFP RR.
 */
static int do_print_resource_record(struct passwd *pw, char *fname,
                                    char *hname) {
...
static int agent_signer(const struct sshkey *key, u_char **sigp, size_t *lenp,
...
static void do_ca_sign(struct passwd *pw, int argc, char **argv) {
  ...
  public
    ...
    if (agent_fd != -1 && (ca->flags & SSHKEY_FLAG_EXT) != 0) {
      if ((r = sshkey_certify_custom(public, ca, key_type_name, agent_signer,
                                     &agent_fd)) != 0)
...
static void do_check_krl(struct passwd *pw, int argc, char **argv) {
  int i, r, ret = 0;
  char *comment;
  struct ssh_krl *krl;
  struct sshkey *k;
...
#ifdef WITH_PQ_AUTH
      " |\n"
      "                   oqsdefault | picnicL1FS | qteslaI | qteslaIIIsize | "
      "qteslaIIIspeed"
#endif
#ifdef WITH_HYBRID_AUTH
      " |\n"
      "                   rsa3072_oqsdefault | p256_oqsdefault | "
      "rsa3072_picnicL1FS | p256_picnicL1FS |\n"
      "                   rsa3072_qteslaI | p256_qteslaI | p384_qteslaIIIsize "
      "| p384_qteslaIIIspeed"
#endif
      "                  ]\n"
...
int main(int argc, char **argv) {
  ...
  while ((opt = getopt(argc, argv,
    ...
    case 'G':
      do_gen_candidates = 1;
      if (strlcpy(out_file, optarg, sizeof(out_file)) >= sizeof(out_file))
    ...
    case 'T':
      ...
      break;
    case 'W':
      generator_wanted = (u_int32_t)strtonum(optarg, 1, UINT_MAX, &errstr);
      if (errstr != NULL)
        fatal("Desired generator invalid: %s (%s)", optarg, errstr);
      break;
#endif /* WITH_OPENSSL */
    case '?':
    default:
  ...
  if (rr_hostname != NULL) {
    ...
    if (have_identity) {
      ...
      n += do_print_resource_record(pw, _PATH_HOST_OQSDEFAULT_KEY_FILE,
                                    rr_hostname);
      n += do_print_resource_record(pw, _PATH_HOST_DILITHIUM_2_KEY_FILE,
                                    rr_hostname);
      n += do_print_resource_record(pw, _PATH_HOST_FALCON_512_KEY_FILE,
                                    rr_hostname);
      n += do_print_resource_record(pw, _PATH_HOST_PICNIC_L1FULL_KEY_FILE,
                                    rr_hostname);
      n += do_print_resource_record(pw, _PATH_HOST_PICNIC3_L1_KEY_FILE,
                                    rr_hostname);
      n += do_print_resource_record(pw, _PATH_HOST_RAINBOW_I_CLASSIC_KEY_FILE,
                                    rr_hostname);
      n += do_print_resource_record(pw, _PATH_HOST_RAINBOW_III_CLASSIC_KEY_FILE,
                                    rr_hostname);
      n += do_print_resource_record(pw, _PATH_HOST_RAINBOW_V_CLASSIC_KEY_FILE,
                                    rr_hostname);
      n += do_print_resource_record(
          pw, _PATH_HOST_SPHINCS_HARAKA_128F_ROBUST_KEY_FILE, rr_hostname);
      n += do_print_resource_record(
          pw, _PATH_HOST_SPHINCS_SHA256_128F_ROBUST_KEY_FILE, rr_hostname);
      n += do_print_resource_record(
          pw, _PATH_HOST_SPHINCS_SHAKE256_128F_ROBUST_KEY_FILE, rr_hostname);
  ...
  if (do_gen_candidates) {
    ...
    if (out == NULL) {
      error("Couldn't open modulus candidate file \"%s\": %s", out_file,
            strerror(errno));
      return (1);
    }
    if (bits == 0)
  ...
  if (do_screen_candidates) {
    ...
    if (prime_test(in, out, rounds == 0 ? 100 : rounds, generator_wanted,
